        ...
        const fetchAnalytics = async () => {
            try {
                ...
                setData({
                    ...
                    averageScore: 78,
                    topicBreakdown: [
                        { name: 'Algebra', score: 85, status: 'Mastered' },
                        { name: 'Geometry', score: 65, status: 'Developing' },
                        { name: 'Calculus', score: 45, status: 'Weak' },
                        { name: 'Trigonometry', score: 90, status: 'Mastered' },
                    ]
                });
                setLoading(false);
            } catch (error) {
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd className="text-2xl font-semibold text-white">{data?.timeSpent}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div className="glass-panel p-6 rounded-lg shadow">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-slate-700">
                        <thead>
                            <tr>
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-slate-400 uppercase tracking-wider">Topic</th>
